...
public class InvoiceLookupView extends JFrame{
	 ...
	 * Create the frame.
	 */	
	public InvoiceLookupView()
	{
//		File logoImage = new File("InvoiceLookupView.jpg");
...
//		setIconImage(Toolkit.getDefaultToolkit().getImage(imagePath));
		...
		labelCustpmerId.setBounds(441, 29, 105, 16);
...
//		File InvoiceLookupView = new File("InvoiceLookupView.jpg");
//		String InvoiceLookupPath = InvoiceLookupView.getPath();
